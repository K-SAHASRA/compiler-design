...
public class GenerateMachineCodeIndexedAssignment {
    public static void main(String[] args) throws IOException {
        ...
        // Write the machine code to a file named machine_code2.bin
        try (FileOutputStream fos = new FileOutputStream("machine_code2.bin")) {
            fos.write(machineCode);
            System.out.println("Machine code written to machine_code2.bin");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
